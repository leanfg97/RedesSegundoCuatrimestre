    ...
    <form action="respuesta2.php" method="post">
        ...
        <div class="cajaContainer1" >
            ...
            <div style="display: flex; justify-content: center; align-items: center; background-color:blue">
               ...
               <input type="image" id="BotonDisparador" src="encriptar.jpg" alt="Enviar" style="display: none; height: 20%; width: auto;">

            </div>
        </div>
        </form>
        <div class="cajaContainer" style="background: yellow; width:30%" id="resultado">
        </div>
        <div class="cajaContainer" style="background: darkslategrey;" id="estado">
        </div>
        <div class="cajaContainer" style="background: lightblue; width:60%">
