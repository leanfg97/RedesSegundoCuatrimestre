...
<style>
 ...
 /*
    ...
    var miInput4 = document.getElementById("Apellidos");
    var miInput4 = document.getElementById("fechaNac");

    document.getElementById("Boton2").onclick= function() {            
    
        if (miInput1.value.length >0 && miInput2.value.length >0 && miInput3.value.length > 0 && miInput4.value.length > 0  ) {
    ...
    <div class="contenedor" id="contenedor">
        ...
        <div class="VentanaModal" id="contenido">
            ...
            <div style="padding-left: 5%; height: 75%; ">
                ...
                <div style="background-color:blue" id="resultado">
                </div>
            </div>
